    ...
    def load_from_txt(self, txt_path):
        try:
            with open(txt_path, 'r') as f:
                lines = f.readlines()
                # Initialize audio_samples array
                ...
                for i, line in enumerate(lines):
                    ...
                    # Clip sample value within int16 range
                    sample = np.clip(sample, -(1 << 15), (1 << 15) - 1)
...
if __name__ == "__main__":
    ...
    wav_from_txt.load_from_txt(txt_path=r"C:\Users\luan1\OneDrive\Desktop\TKS\Lab\Lab4\Tools\scale\output16bit.txt")
    wav_from_txt.save_as(save_path="equalizer_ouput.wav")
